// AgriEnergyConnectPlatform.Data/ApplicationDbContext.cs
    ...
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Employee>()
                ...
                .WithOne() // IdentityUser can have one Employee profile
                .HasForeignKey<Employee>(e => e.IdentityUserId)
                .IsRequired() // An Employee record must be linked to an IdentityUser
                .OnDelete(DeleteBehavior.Cascade); // If IdentityUser is deleted, delete Employee profile
